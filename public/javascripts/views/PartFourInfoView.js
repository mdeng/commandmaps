define([
	...
	'underscore',
	'backbone',
	'text!../templates/part_four_info.html'
	], function($, _, Backbone, instruct) {
		
		var PartFourInfoView = Backbone.View.extend({
			el: '#overlay-container',
			events: {
				'click button#btn-begin-four': 'onClickBegin'
			},
			initialize: function() {
			...
			onClickBegin: function(e) {
				...
				Backbone.history.navigate('4-main', {trigger: true, replace: true});
			}
		});
		return PartFourInfoView;
});
